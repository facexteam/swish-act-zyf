...
bn_mom=0.9, workspace=256, memonger=False, act_type = 'swish'):
...
bn_mom=0.9, workspace=256, dtype='float32', memonger=False, act_type='swish'):
    ...
    for i in range(num_stages):
        body = residual_unit(body, filter_list[i+1], (1 if i==0 else 2, 1 if i==0 else 2), False,
                             ...
                             memonger=memonger, act_type=act_type)
...
def get_symbol(num_classes, num_layers, image_shape, conv_workspace=256, dtype='float32', act_type='swish', **kwargs):
    """
